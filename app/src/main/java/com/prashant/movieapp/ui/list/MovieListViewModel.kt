...
class MovieListViewModel: BaseViewModel() {
    ...
    fun getUpcommingMovies() {
        mCompositeDisposable.add(mApiService.getUpcommingMovies(mApiKey,mLanguage,mPage)
            .subscribeOn(Schedulers.io())
            .observeOn( AndroidSchedulers.mainThread())
            .subscribe({ commonResponse ->
                if (commonResponse?.results != null) {
    ...
    fun getLatestTVShows() {
        //mCallBack.showLoading()
        mCompositeDisposable.add(mApiService.getLatestTVShows(mApiKey,mLanguage,mPage)
            .subscribeOn(Schedulers.io())
            .observeOn( AndroidSchedulers.mainThread())
            .subscribe({ commonResponse ->
                //                mCallBack.hideLoading()
    ...
    fun getPoularTVShows() {
        mCompositeDisposable.add(mApiService.getPoularTVShows(mApiKey,mLanguage,mPage)
            .subscribeOn(Schedulers.io())
            .observeOn( AndroidSchedulers.mainThread())
            .subscribe({ commonResponse ->
                if (commonResponse?.results != null) {
    ...
    fun getTopRatedTVShows() {
        mCompositeDisposable.add(mApiService.getTopRatedTVShows(mApiKey,mLanguage,mPage)
            .subscribeOn(Schedulers.io())
            .observeOn( AndroidSchedulers.mainThread())
            .subscribe({ commonResponse ->
                if (commonResponse?.results != null) {
    ...
    fun getAiringTodayTVShows() {
        mCompositeDisposable.add(mApiService.getAiringTodayTVShows(mApiKey,mLanguage,mPage)
            .subscribeOn(Schedulers.io())
            .observeOn( AndroidSchedulers.mainThread())
            .subscribe({ commonResponse ->
                if (commonResponse?.results != null) {
